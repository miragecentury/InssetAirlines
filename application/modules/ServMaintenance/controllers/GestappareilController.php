            ...
            if ($id >= 0) {
                ...
                if ($avion instanceof ServMaintenance_Model_Avion) {
                    ...
                    $this->getResponse()->setHeader('refresh', '2,url=' . Zend_Registry::get('BaseUrl') .
                            '/ServMaintenance/Gestappareil/Misehorsservice');
                }
            } else {
                $this->getResponse()->setHeader('refresh', '0,url=' . Zend_Registry::get('BaseUrl') .
                        '/ServMaintenance/Gestappareil/Misehorsservice');
            }
...
//ok ready to save
                        ...
                        if ($avion instanceof ServMaintenance_Model_Avion) {
                            ...
                            $dateTime = new DateTime($_POST['dateMiseService']);
                            $avion->set_dateMiseService($dateTime->format(DATE_ATOM));
