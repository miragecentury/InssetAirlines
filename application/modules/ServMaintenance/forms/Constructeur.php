...
class ServMaintenance_Form_Constructeur extends Zend_Form
{
    ...
    {
        //init : Décorateurs utilisée pour l'adresse
        ...
        //initialisation de la methode de form
        $this->setMethod('POST');
        //Element 1 ...
...
//11e ..
        ...
        $this->addDisplayGroup(array('numero',
            'porte',
            'etage',
            'immeuble',
            'clear',
            ...
            'pays',
            'commentaire',
            'clear2'), 'adresseGroupe', array('legend' => 'Adresse du constructeur :'));
